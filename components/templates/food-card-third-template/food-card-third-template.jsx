...
function FoodCardThirdTemplate({ className }) {
   return (
      <div className={`flex max-w-[620px] shrink-0 rounded-xl bg-white p-2 ${className}`}>
         <Link href="/" className="relative aspect-square h-[100px] shrink-0">
         ...
         <div className="flex flex-col justify-end">
            <Link href="/" className="block h-4 text-left font-rokhFaNum text-xs font-bold text-[#D39090] line-through">
               {Number('420000').toLocaleString('fa-IR')}
            </Link>

            <Link href="/" className="mt-1 flex h-[25px] items-center gap-1 text-xs font-bold">
