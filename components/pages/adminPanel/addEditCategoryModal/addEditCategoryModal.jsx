...
function AddEditCategoryModal({ show, onClose, isEdit = false, detail }) {
   ...
   const formSubmit = data => {
      if (!coverImage) {
         toast.info('لطفا برای دسته بندی یک کاور انتخاب کنید');
      } else if (isEdit) {
   ...
   return (
      <Dialog open={show} onClose={closeModalHandler} dir="rtl" fullWidth maxWidth="xs">
         <div className="relative p-5 pt-0 font-rokhRegular">
            ...
            {isEdit && categoryDetailIsLoading ? (
               ...
               <>
                  ...
                  <form onSubmit={handleSubmit(formSubmit)} className="mt-3">
                     <div className="flex flex-1 flex-col gap-1">
                        <p className="mb-2 text-sm text-[#626E94]">نام دسته بندی</p>
                        <TextField
                           fullWidth
                           {...register('title', {
                              required: {
