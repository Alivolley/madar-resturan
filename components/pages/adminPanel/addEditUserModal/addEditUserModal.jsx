      ...
      <Dialog open={show} onClose={closeModalHandler} fullWidth dir="rtl" maxWidth="xs">
         <div className="relative p-5 pt-0 font-rokhRegular">
            <div className="sticky top-0 z-[2] flex items-center justify-between border-b border-solid border-[#E4EAF0] bg-white pb-2 pt-3">
               <p className="text-lg font-bold">{isEdit ? 'ویرایش کاربر' : 'افزودن کاربر'}</p>
            ...
            <form onSubmit={handleSubmit(formSubmit)} className="mt-10 space-y-4">
               <div className="flex flex-1 flex-col gap-1">
                  <p className="text-sm font-bold text-[#713802]">شماره تلفن</p>
                  ...
                  <Controller
                     ...
                     render={({ field: { onChange, value } }) => (
                        <FormControlLabel
                           ...
                           label={<p className="font-rokhRegular">ادمین است</p>}
                           value={value}
                           onChange={onChange}
                        />
                     )}
               ...
               {isAdminCheckbox && (
                  <>
                     <div className="flex flex-1 flex-col gap-1">
                        <p className="text-sm font-bold text-[#713802]">دسترسی ها</p>
                        <Controller
                           control={control}
                           name="permissions"
                     ...
                     <div className="flex flex-1 flex-col gap-1">
                        <p className="text-sm font-bold text-[#713802]">پسورد</p>
                        <TextField
                           variant="outlined"
                           fullWidth
                           autoComplete="off"
                           {...register('password', {
                              ...
                              minLength: {
                                 value: 8,
                                 message: 'پسورد نباید از ۸ کلمه کوتاه تر باشد',
                              },
                           })}
